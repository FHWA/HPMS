...
# Data specifications
The HPMS Field Manual is the data collection guidance for the state data providers and also serves as the HPMS Data Dictionary and can be viewed at: https://www.fhwa.dot.gov/policyinformation/hpms/fieldmanual/.
