...
# Summary
This README describes the 2024_HPMS_FS7.geojson export produced by an R script that extracts State Local (F_System = 7) Highway Performance Monitoring System (HPMS) records for DataYear = 2024 from an SQL Server database, converts the WKB/EWKB geometry to an sf object, and writes spatial outputs (GeoJSON, KML, KMZ). This README accompanies the GeoJSON output and documents metadata, provenance, usage, and known limitations.

# Dataset summary
- URL: https://datahub.transportation.gov/Roadways-and-Bridges/HPMS-Spatial-Local-Sections-2024/sm8p-9cce/
- Feature count: 9,664,917 observations (rows)
- File size: 23.2 GB
- Generated: 2025-10-01
- Version: 2024_HPMS_FS7 v1
- SHA-256 checksum of GeoJSON: ff937fb75d904818b8eb9410aada416a278fde59f3786090afd14d8f34194fbe

# Files in this package
2024_HPMS_FS7.geojson - primary GeoJSON file containing HPMS features (LINESTRING) and attributes.

# Provenance & source
- Source database: HPMS9 (SQL Server)
- Source table: Gold.FullSpatialJoins (as queried by the R script)
- Query filter: DataYear = 2024 AND F_System = 7
...
- Users wanting to replicate the data in the FHWA publication Highway Statistics, should be aware that some data items are not provided for rural Minor Collectors and all Local roads.  These data will need to be pulled from appropriate summary table available on the Data Access for HPMS site at: https://data.transportation.gov/stories/s/3uu4-47sa.
...
- U.S. Department of Transportation, Federal Highway Administration, Office of Highway Policy Information: 2024 Highway Performance Monitoring System (HPMS) Interstate Sections (Washington, DC: 2025). Data set: 2024_HPMS_FS7.geojson (Version 2024_HPMS_FS7 v1). Generated 2025-10-01. Public domain. SHA-256: ff937fb75d904818b8eb9410aada416a278fde59f3786090afd14d8f34194fbe. Contact: PolicyInfoFeedback@dot.gov

## Formal citations
- APA 

	U.S. Federal Highway Administration, Office of Highway Policy Information. (2025). 2024_HPMS_FS7.geojson (Version 2024_HPMS_FS7 v1) [Data set]. Generated 2025-10-01. Public domain. SHA-256: ff937fb75d904818b8eb9410aada416a278fde59f3786090afd14d8f34194fbe. Contact: PolicyInfoFeedback@dot.gov

- MLA 

	U.S. Federal Highway Administration, Office of Highway Policy Information. 2024_HPMS_FS7.geojson. Version 2024_HPMS_FS7 v1, U.S. Federal Highway Administration, 01 Oct. 2025. Public domain. SHA-256: ff937fb75d904818b8eb9410aada416a278fde59f3786090afd14d8f34194fbe. Accessed [DATE]. PolicyInfoFeedback@dot.gov .

- Chicago (Author-Date) 

	U.S. Federal Highway Administration, Office of Highway Policy Information. 2025. "2024_HPMS_FS7.geojson." Version 2024_HPMS_FS7 v1. U.S. Federal Highway Administration. Generated October 1, 2025. Public domain. SHA-256: ff937fb75d904818b8eb9410aada416a278fde59f3786090afd14d8f34194fbe. (Accessed [Month Day, Year]).
