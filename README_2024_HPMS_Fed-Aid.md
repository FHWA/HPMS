...
# Summary
This README describes the 2024_HPMS_Fed-Aid.geojson export produced by an R script that extracts State Federal-Aid system (F_System < 6 OR (F_System = 6 AND Urban_ID < 99999)) Highway Performance Monitoring System (HPMS) records for DataYear = 2024 from an SQL Server database, converts the WKB/EWKB geometry to an sf object, and writes spatial outputs (GeoJSON, KML, KMZ). This README accompanies the GeoJSON output and documents metadata, provenance, usage, and known limitations.

# Dataset summary
- URL: https://datahub.transportation.gov/dataset/HPMS-Spatial-Fed-Aid-Sections-2024/8343-egp4/
- Feature count: 8,251,196 observations (rows)
- File size: 17.9 GB
- Generated: 2025-10-02
- Version: 2024_HPMS_Fed-Aid v1
- SHA-256 checksum of GeoJSON: 097362362d7ead4b93186f37e6ba6dd73865b7bba5d0ef5343f340da877e7619

# Files in this package
2024_HPMS_Fed-Aid.geojson - primary GeoJSON file containing HPMS features (LINESTRING) and attributes.

# Provenance & source
- Source database: HPMS9 (SQL Server)
- Source table: Gold.FullSpatialJoins (as queried by the R script)
- Query filter: DataYear = 2024 AND (F_System < 6 OR (F_System = 6 AND Urban_ID < 99999))
...
Typical R example:
- library(sf)
- sf <- st_read("2024_HPMS_Fed-Aid.geojson")

Typical Python (GeoPandas) example:
- import geopandas as gpd
- gdf = gpd.read_file("2024_HPMS_Fed-Aid.geojson")
...
- U.S. Department of Transportation, Federal Highway Administration, Office of Highway Policy Information: 2024 Highway Performance Monitoring System (HPMS) Interstate Sections (Washington, DC: 2025). Data set: 2024_HPMS_Fed-Aid.geojson (Version 2024_HPMS_Fed-Aid v1). Generated 2025-10-02. Public domain. SHA-256: 097362362d7ead4b93186f37e6ba6dd73865b7bba5d0ef5343f340da877e7619. Contact: PolicyInfoFeedback@dot.gov

## Formal citations
- APA 

	U.S. Federal Highway Administration, Office of Highway Policy Information. (2025). 2024_HPMS_Fed-Aid.geojson (Version 2024_HPMS_Fed-Aid v1) [Data set]. Generated 2025-10-02. Public domain. SHA-256: 097362362d7ead4b93186f37e6ba6dd73865b7bba5d0ef5343f340da877e7619. Contact: PolicyInfoFeedback@dot.gov

- MLA 

	U.S. Federal Highway Administration, Office of Highway Policy Information. 2024_HPMS_Fed-Aid.geojson. Version 2024_HPMS_Fed-Aid v1, U.S. Federal Highway Administration, 02 Oct. 2025. Public domain. SHA-256: 097362362d7ead4b93186f37e6ba6dd73865b7bba5d0ef5343f340da877e7619. Accessed [DATE]. PolicyInfoFeedback@dot.gov .

- Chicago (Author-Date) 

	U.S. Federal Highway Administration, Office of Highway Policy Information. 2025. "2024_HPMS_Fed-Aid.geojson." Version 2024_HPMS_Fed-Aid v1. U.S. Federal Highway Administration. Generated October 2, 2025. Public domain. SHA-256: 097362362d7ead4b93186f37e6ba6dd73865b7bba5d0ef5343f340da877e7619. (Accessed [Month Day, Year]).
