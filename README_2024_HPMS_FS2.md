...
- Feature count: 356,081 observations (rows)
- File size: 164,299,635 bytes (CSV)
...
- Query filter: DataYear = 2024 AND F_System = 2 AND Is_Restricted is NULL AND Urban_ID > 0 AND Facility_Type in (1, 2, 6) 
